...
Manages the practice session lifecycle including position selection, situation presentation loop, answer evaluation, statistics tracking, and session exit.
